  ...
  return (
    <div className="relative h-[95vh]">
      ...
      <div className="mt-20 social-links flex items-center bg-green-600 relative">
        <div className={"bg-purple-600 border border-purple-600 hover:bg-transparent hover:border-white transition-all duration-500 absolute cursor-pointer -left-8 p-2 px-3 flex items-center gap-3 rounded-tr-xl rounded-br-xl"}>
          Github
